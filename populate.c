...
static Contact dummyContacts[] = {
    {"John Doe", "1234567990", "john@example.com"},
    {"vinod", "1234567890", "vinod@1.com"},
    {"Alice Smith", "0987653321", "alice@example.com"},
    ...
    {"vinod", "1122334455", "vinod@123.com"},
};
